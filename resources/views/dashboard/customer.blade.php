    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="card bg-base-100 shadow-xl border border-base-300">
                <div class="card-header p-6 border-b border-base-300">
                    <div class="flex justify-between items-center">
                        <h3 class="text-lg font-medium text-base-content">Recent Service Reports</h3>
                        <a href="{{ route('reports.index') }}" class="text-sm text-primary hover:text-primary/80">View All</a>
                    </div>
                </div>
                <div class="card-body p-6">
                    @if($recentReports->count() > 0)
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-4 bg-base-200 rounded-lg">
                                <div>
                                    <p class="font-medium text-base-content">{{ $report->location->full_address }}</p>
            ...
            <div class="card bg-base-100 shadow-xl border border-base-300">
                ...
                <div class="card-body p-6">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <a href="{{ route('reports.index') }}" class="flex items-center p-4 bg-secondary/10 rounded-lg hover:bg-secondary/20 transition-colors">
                            ...
                            <div class="ml-4">
                                <p class="font-medium text-base-content">Service Reports</p>
                                <p class="text-sm text-base-content/70">View service history</p>
                            </div>
                        </a>
                    </div>
                </div>
