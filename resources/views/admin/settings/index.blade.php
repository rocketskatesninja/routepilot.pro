...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex space-x-8">
            ...
            <a href="{{ route('admin.settings.index', ['tab' => 'uploads']) }}" 
               class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition duration-150 ease-in-out {{ $activeTab === 'uploads' ? 'border-primary text-base-content' : 'border-transparent text-base-content/70 hover:text-base-content hover:border-base-300 focus:outline-none focus:text-base-content focus:border-base-300' }}">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-base-100 rounded-lg shadow-lg p-6">
        ...
        @elseif($activeTab === 'uploads')
            @include('admin.settings.partials.uploads')
        @endif
    </div>
</div>
